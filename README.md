# Bonewalk for Color Computer 3 for MAME Emulator

Color Computer 3 maze runner — **320×192, 16-color** graphics. MAME `coco3` target. This is a sample game created entirely by Cursor/Grok for the coco3 MCP server.
